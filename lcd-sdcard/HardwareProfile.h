...
*/
        ...
        // Description: SD-SPI Chip Select Output bit
        #define SD_CS               PORTAbits.RA3
        // Description: SD-SPI Chip Select TRIS bit
        #define SD_CS_TRIS          TRISAbits.TRISA3
        ...
        // Description: SD-SPI Write Protect Check Input bit
        #define SD_WE               PORTBbits.RB12
        // Description: SD-SPI Write Protect Check TRIS bit
        #define SD_WE_TRIS          TRISBbits.TRISB12
        ...
        // Description: The TRIS bit for the SCK pin
        #define SPICLOCK            TRISBbits.TRISB5
        // Description: The TRIS bit for the SDI pin
        #define SPIIN               TRISBbits.TRISB6
        // Description: The TRIS bit for the SDO pin
        #define SPIOUT              TRISBbits.TRISB7
