	...
	; Compiler options:
	;
	; -o7seg-led.cof -m7seg-led.map --summary=default --output=default \
	; 7seg-led.p1 i2cs-led7.p1 --chip=16F88 -P --runtime=default \
...
;	10 bytes of RAM objects in common bank to zero
	...
	movwf	FSR
	movlw	low(__Lcommon+10)		;load the high address+1 into W
